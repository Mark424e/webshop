...
<body class="bg-gray-100">
    ...
    <div class="max-w-md mx-auto p-6 bg-white rounded shadow-md my-40">
        <h2 class="text-2xl font-semibold mb-6">Edit Product</h2>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=" . urlencode($product_id); ?>" method="post" enctype="multipart/form-data">
            <div class="mb-4">
                <label for="name" class="block text-gray-700 font-bold mb-2">Name:</label>
                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($name); ?>" class="border rounded w-full py-2 px-3">
            </div>
            <div class="mb-4">
                <label for="price" class="block text-gray-700 font-bold mb-2">Price:</label>
                <input type="number" id="price" name="price" value="<?php echo htmlspecialchars($price); ?>" class="border rounded w-full py-2 px-3">
            </div>
            <div class="mb-4">
                <label for="description" class="block text-gray-700 font-bold mb-2">Description:</label>
                <textarea id="description" name="description" class="border rounded w-full py-2 px-3"><?php echo htmlspecialchars($description); ?></textarea>
            </div>
